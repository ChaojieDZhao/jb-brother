...
//单字节时什么都不用做，再次读取字节
	 ...
	 * @return
	 */
	private static boolean checkMultiByte(BufferedInputStream bis, BitSet bitSet)
		throws Exception
	{
		...
		throws Exception
	{
		...
		BufferedReader bin =
			new BufferedReader(new InputStreamReader(new FileInputStream(oldFullFileName), oldCharsetName));
		String line;
