...
public class BitsCounter
{
	 ...
	 * the integer passed as parameter checking if the bit at the first position is fileDownload or zero.
	 * <p>
	 ...
	 * to keep the count of digits to fileDownload in binary.
	 */
